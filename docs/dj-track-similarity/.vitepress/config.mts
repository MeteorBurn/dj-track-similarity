...
const englishSidebar: SidebarSection[] = [
  ...
  { text: "Tools and scripts", items: [{ text: "Overview", link: "/tools-and-scripts/" }, { text: "Rhythm Lab", link: "/tools-and-scripts/rhythm-lab.html" }, { text: "Audio Dedup", link: "/tools-and-scripts/audio-dedup.html" }, { text: "Audio Doctor", link: "/tools-and-scripts/audio-doctor.html" }, { text: "KGLite bridge", link: "/tools-and-scripts/kglite-bridge.html" }, { text: "Persistent ANN indexes", link: "/tools-and-scripts/persistent-ann-indexes.html" }, { text: "Optimize database", link: "/tools-and-scripts/optimize-database.html" }] },
