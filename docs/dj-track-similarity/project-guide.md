...
Use this map to choose the shortest path for your task. Start with tutorials when setting up a new database. Use workflows for DJ tasks, and use reference pages when you already know the feature name or command.
