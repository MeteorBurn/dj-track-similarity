export const helpText = {
  ...
  sonaraAnalyze: "SONARA запускается отдельно от ML-моделей: ffmpeg сразу декодирует mono 22050 Гц, затем Rust DSP считает BPM, key и музыкальные признаки.",
  ...
  muqAnalyze: "MuQ строит fp32 аудио-эмбеддинги из 24 kHz сигнала. Сейчас сохраняется как отдельный слой анализа без поиска и SET.",
  clapAnalyze: "CLAP строит music-focused аудио-эмбеддинги для поиска по текстовому описанию звучания.",
  classifiersAnalyze: "CLASSIFIERS использует только заранее рассчитанные совместимые SONARA, MERT и MAEST данные. SONARA нужно запускать отдельной задачей.",
  ...
  analysisInferenceBatchSize: "Сколько окон/семплов MAEST, MERT, MuQ и CLAP прогоняют за один model forward pass. Тип: целое число 1-128. Для RTX 3090 дефолт 24.",
