export const helpText = {
  ...
  sonaraMixerDynamics: "Вес динамики: energy, RMS, LUFS, SONARA 2.0 loudness range и momentary max. Повышай для похожего давления, дыхания и громкости.",
  sonaraMixerHarmonic: "Вес гармонического цвета: chroma, dissonance, chord change, key confidence и SONARA Camelot key. Повышай для похожего аккордового ощущения.",
  ...
  sonaraModifierVocalness: "Направление vocalness: ниже = инструментальнее, выше = больше вокального присутствия по SONARA 2.0.",
