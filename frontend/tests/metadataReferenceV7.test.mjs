...
function detail() {
  return {
    ...
    classifier_scores_detail: [{
      ...
      required_outputs_hash: "outputs",
      model_id: "voice-model",
      uses_sonara: false,
      sonara_release_hash: null,
...
test("track display and analysis coverage use only v7 summary fields", () => {
...
test("App aborts superseded detail requests and commits only the clicked v7 identity", () => {
