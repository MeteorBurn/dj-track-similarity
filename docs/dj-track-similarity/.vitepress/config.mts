...
const englishSidebar: SidebarSection[] = [
  ...
  { text: "Tools and scripts", items: [{ text: "Overview", link: "/tools-and-scripts/" }, { text: "Rhythm Lab", link: "/tools-and-scripts/rhythm-lab.html" }, { text: "Audio Dedup", link: "/tools-and-scripts/audio-dedup.html" }, { text: "Audio Doctor", link: "/tools-and-scripts/audio-doctor.html" }, { text: "Optimize database", link: "/tools-and-scripts/optimize-database.html" }] },
  { text: "Reference", items: [{ text: "Overview", link: "/reference/" }, { text: "Commands and arguments", link: "/reference/commands.html" }, { text: "CLI", link: "/reference/cli.html" }, { text: "API", link: "/reference/api.html" }, { text: "Database", link: "/reference/database.html" }, { text: "Configuration", link: "/reference/configuration.html" }, { text: "Analysis families", link: "/reference/analysis-families.html" }, { text: "Sonara integration", link: "/reference/sonara-integration.html" }, { text: "Model citations", link: "/reference/model-citations.html" }, { text: "UI controls", link: "/reference/ui-controls.html" }] },
