...
Есть два ограничения по исполнителям: известный исполнитель не ставится подряд,
и один известный исполнитель может появиться в одном preview не больше трёх
раз. Manual seeds остаются отмеченными как `seed_anchor`, но builder может
вставить между ними сгенерированные треки, если иначе нарушится правило
исполнителя.
