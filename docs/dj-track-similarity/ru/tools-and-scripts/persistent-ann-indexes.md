...
Если вспомогательный файл отсутствует, устарел или не поддерживается, команда завершается ошибкой.
Не указывайте `--use-ann-index`, когда нужен точный поиск без вспомогательного индекса.
