...
preview не больше трёх раз. Manual seed-треки сохраняются как `seed_anchor`,
но могут быть разнесены сгенерированными треками, если это нужно для соблюдения
artist spacing.
