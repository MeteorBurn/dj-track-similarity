...
const englishSidebar: SidebarSection[] = [
  ...
  { text: "User guide", items: [{ text: "Overview", link: "/user-guide/" }, { text: "Browse library", link: "/user-guide/browse-library.html" }, { text: "Analyze library", link: "/user-guide/analyze-library.html" }, { text: "Search with seeds", link: "/user-guide/search-with-seeds.html" }, { text: "Text search", link: "/user-guide/text-search.html" }, { text: "Classifier tab", link: "/user-guide/class-tab.html" }, { text: "Export playlists", link: "/user-guide/export-playlists.html" }, { text: "Tags and audio writes", link: "/user-guide/tags-and-audio-writes.html" }] },
  { text: "Workflows", items: [{ text: "Overview", link: "/workflows/" }, { text: "Find compatible tracks", link: "/workflows/find-compatible-tracks.html" }, { text: "Build crates", link: "/workflows/build-crates.html" }, { text: "Train classifier", link: "/workflows/train-personal-classifier.html" }, { text: "Reanalyze split Sonara storage", link: "/workflows/reanalyze-sonara-split-storage.html" }, { text: "Maintain library", link: "/workflows/maintain-library.html" }] },
  { text: "Concepts", items: [{ text: "Overview", link: "/concepts/" }, { text: "Project idea", link: "/concepts/project-idea.html" }, { text: "Local-first safety", link: "/concepts/local-first-safety.html" }, { text: "Features, embeddings, tags", link: "/concepts/features-embeddings-tags.html" }, { text: "Similarity scores", link: "/concepts/similarity-scores.html" }, { text: "Classifiers and Rhythm Lab", link: "/concepts/classifiers-and-rhythm-lab.html" }] },
  { text: "Tools and scripts", items: [{ text: "Overview", link: "/tools-and-scripts/" }, { text: "Rhythm Lab", link: "/tools-and-scripts/rhythm-lab.html" }, { text: "Audio Dedup", link: "/tools-and-scripts/audio-dedup.html" }, { text: "Audio Doctor", link: "/tools-and-scripts/audio-doctor.html" }, { text: "Optimize database", link: "/tools-and-scripts/optimize-database.html" }, { text: "Audio Online", link: "/tools-and-scripts/audio-online.html" }, { text: "Scripts", link: "/tools-and-scripts/scripts.html" }] },
  { text: "Reference", items: [{ text: "Overview", link: "/reference/" }, { text: "CLI reference", link: "/reference/commands.html" }, { text: "API", link: "/reference/api.html" }, { text: "Database", link: "/reference/database.html" }, { text: "Configuration", link: "/reference/configuration.html" }, { text: "Analysis families", link: "/reference/analysis-families.html" }, { text: "Sonara integration", link: "/reference/sonara-integration.html" }, { text: "Model citations", link: "/reference/model-citations.html" }, { text: "UI controls", link: "/reference/ui-controls.html" }] },
  ...
  { text: "Help", items: [{ text: "Overview", link: "/help/" }, { text: "UI language", link: "/help/ui-language.html" }, { text: "Troubleshooting", link: "/help/troubleshooting.html" }, { text: "FAQ", link: "/help/faq.html" }, { text: "Known limits", link: "/help/known-limits.html" }] }
];
