...
| --- | --- | --- | --- |
| SONARA | Current tested package `0.3.5`, playlist mode with BPM range `70.0..180.0`; Core uses the bundled vocalness selector | [kkollsga/sonara](https://github.com/kkollsga/sonara), [v0.3.5 release](https://github.com/kkollsga/sonara/releases/tag/v0.3.5) | Upstream is MIT. Preserve its license and check terms before redistribution. |
