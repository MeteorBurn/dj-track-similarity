 ...
 * what notes it plays, how that is coloured and placed, how much of it there
 * is, how it feels, and what it is for. The picker renders this order, so the
 * axes next to each other are the ones reached for together.
 */
export const textPromptAxes: TextPromptAxis[] = [
  { key: "rhythm", label: "Rhythm", hint: "Рисунок бита: брейки, ровная бочка, халфтайм, two-step, полиритмия. Про то, куда попадают удары, а не как они звучат.", model: "mulan" },
  { key: "groove", label: "Groove", hint: "Кач и микротайминг: свинг, шафл, триоли, жёсткая сетка или расхлябанность. Про то, как смещены доли, а не какой у трека рисунок бита — рисунок на оси Rhythm." },
  { key: "percussion", label: "Percussion", hint: "Характер перкуссии: кликовая, деревянная, глитчевая, шейкеры, хэты. Про тембр и поведение ударных, а не про их рисунок — рисунок на оси Rhythm." },
  { key: "bass", label: "Bass", hint: "Характер баса: саб, кислота, рииз, FM, резина, перегруз. Про то, чем сделан низ и как он движется." },
  { key: "synths", label: "Synths", hint: "Характер синтезаторов: квирки, пластик, вода, пилы, блипы, пэды, модуляр." },
  { key: "instruments", label: "Instruments", hint: "Конкретные инструменты и машины, которые слышно в треке: от калимбы и ситара до драм-машин. Ищет и сыгранное вживую, и сэмпл внутри электроники." },
  { key: "voice", label: "Vocals", hint: "Присутствие и характер голоса: вокал, речь, нарезки, хор, инструментал." },
  { key: "harmony", label: "Harmony", hint: "Аккорды и то, как часто они меняются: модальность, диссонанс, дрон, джазовые расширения." },
  { key: "movement", label: "Movement", hint: "Движение внутри звука: арпеджио, свипы, морфинг, качание сайдчейна, шагающие линии. Про то, что шевелится в самом звуке, а не про структуру трека во времени." },
  { key: "timbre", label: "Timbre", hint: "Окраска тона: металл, стекло, резонанс, тепло и холод. Точнее срабатывает в связке с источником — добавь метку с осей Percussion, Bass или Synths." },
  { key: "texture", label: "Texture", hint: "Обработка поверхности: лента, пыль, сатурация, глитч, дымка, чистота. Про то, что сделали со звуком после записи, а не про его собственный тон — тон на оси Timbre.", model: "clap" },
  { key: "organic", label: "Organic", hint: "Происхождение звука как континуум: живое и сыгранное руками ↔ синтетическое и запрограммированное." },
  { key: "space", label: "Space", hint: "Пространство вокруг звука: сухо, комната, пещера, дилей, ширина стерео." },
  { key: "density", label: "Density", hint: "Плотность аранжировки: воздух и пустота ↔ стена слоёв. Про то, сколько всего звучит одновременно." },
  ...
  { key: "energy", label: "Energy", hint: "Уровень мощности: сдержанно ↔ на всю. Про напор самого звука, а не про роль в сете — роль на оси Function." },
...
export const textPromptPresets: TextPromptPreset[] = [
  ...
  },
  {
    ...
    axis: "texture",
    label: "Clean / Hi-fi",
    hint: "Чистый современный продакшн: широкий прозрачный микс, острые транзиенты, ничего лишнего на поверхности.",
    positive: {
      shared: [
  ...
  },
  {
    ...
    hint: "Живой полюс оси: натуральный тембр, игра руками, человеческий тайминг.",
    positive: {
      shared: [
        "acoustic.",
  ...
  },
  {
    ...
    axis: "abstract",
    label: "Experimental",
    hint: "Абстрактное и странное: рваный ритм, необычная фактура, звук вне танцевальной функции.",
    positive: {
      shared: [
  ...
  },
  {
    ...
    axis: "timbre",
    label: "Glassy",
    hint: "Стеклянные кристальные верхи: колокольчики, звонкие синты, хрупкая звенящая атака.",
    positive: {
      shared: [
  ...
  },
  {
    ...
    axis: "harmony",
    label: "Jazz chords",
    hint: "Расширенные джазовые аккорды: септимы, ноны, тринадцатые.",
    positive: {
      shared: [
  ...
  },
  {
    ...
    axis: "voice",
    label: "Male lead",
    hint: "Мужской ведущий вокал: низкий голос ведёт мелодию. Границу между мужским и женским метка держит нестрого — проверяй ушами.",
    positive: {
      shared: [
  ...
  },
  {
    ...
    axis: "instruments",
    label: "Sitar",
    hint: "Ситар: гудящие струны и сильный резонанс, характерное скольжение между нот.",
    positive: {
      shared: [
        "A track with sitar.",
  ...
  },
  {
    ...
    axis: "instruments",
    label: "Steel drums",
    hint: "Стил-пэн: настроенные металлические пэны, звонкий карибский тон.",
    positive: {
      shared: [
