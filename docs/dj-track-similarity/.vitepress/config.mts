...
const englishSidebar: SidebarSection[] = [
  ...
  { text: "Workflows", items: [{ text: "Overview", link: "/workflows/" }, { text: "Prepare a set", link: "/workflows/prepare-a-set.html" }, { text: "Find compatible tracks", link: "/workflows/find-compatible-tracks.html" }, { text: "Build crates", link: "/workflows/build-crates.html" }, { text: "Train classifier", link: "/workflows/train-personal-classifier.html" }, { text: "Migrate SONARA v0.2.4", link: "/workflows/migrate-sonara-v0-2-4.html" }, { text: "Maintain library", link: "/workflows/maintain-library.html" }] },
  ...
  { text: "Reference", items: [{ text: "Overview", link: "/reference/" }, { text: "CLI", link: "/reference/cli.html" }, { text: "API", link: "/reference/api.html" }, { text: "Database", link: "/reference/database.html" }, { text: "Configuration", link: "/reference/configuration.html" }, { text: "Analysis families", link: "/reference/analysis-families.html" }, { text: "SONARA v0.2.4 contract", link: "/reference/sonara-v0-2-4-contract.html" }, { text: "Model citations", link: "/reference/model-citations.html" }, { text: "UI controls", link: "/reference/ui-controls.html" }] },
