export const helpText = {
  ...
  textPrompt: "Банк промптов для текстового поиска. Одна строка — один промпт на английском, банк усредняется. Описывай слышимое: genre/style, rhythm/drums, bass, texture, instruments, space и vocal presence. Не полагайся на metadata, artist refs или отрицания вроде no/without — нежелательные классы называй в поле Negative.",
