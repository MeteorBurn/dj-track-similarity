...
def _status(db_path: Path, xlsx_path: Path | None = None):
    return {
        ...
        "json_path": "C:/projects/dj-track-similarity/tools/audio-doctor/data/reports/audio_doctor_report.json",
        "xlsx_path": str(xlsx_path) if xlsx_path else None,
        "log_path": "C:/projects/dj-track-similarity/tools/audio-doctor/data/reports/audio_doctor_report.log",
        "state_path": "C:/projects/dj-track-similarity/tools/audio-doctor/data/state/state.db.json",
        "started_at": 1,
        "finished_at": 2,
