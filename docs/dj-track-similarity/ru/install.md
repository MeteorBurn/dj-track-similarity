...
[Справочник CLI](cli.md), чтобы просканировать папку и запустить сервер.
...
- Используйте [Справочник CLI](cli.md), чтобы просканировать папку и запустить
  сервер.
- См. [Модели анализа](models.md) о том, что делает каждая модель и какие extras
  ей нужны, и [Семейства анализа](analysis.md), чтобы решить, какой проход
  запускать первым.
