...
После подготовки SONARA из CLI запускайте те же задачи v7 флажками моделей в браузере. Начальное
значение **Analyze limit** равно `0` и означает всю подходящую фонотеку. Результаты SONARA, размеры
