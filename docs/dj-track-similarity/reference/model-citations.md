...
| --- | --- | --- | --- |
| SONARA | `sonara==0.2.4`, schema 3, playlist mode with BPM range `79.0..192.0`; exact provenance is stored per track | [kkollsga/sonara](https://github.com/kkollsga/sonara) | Check the repository license before reuse. |
