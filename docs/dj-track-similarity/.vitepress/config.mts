...
const englishSidebar: SidebarSection[] = [
  ...
  { text: "User guide", items: [{ text: "Overview", link: "/user-guide/" }, { text: "Browse library", link: "/user-guide/browse-library.html" }, { text: "Analyze library", link: "/user-guide/analyze-library.html" }, { text: "Search with seeds", link: "/user-guide/search-with-seeds.html" }, { text: "Text search", link: "/user-guide/text-search.html" }, { text: "Class tab", link: "/user-guide/class-tab.html" }, { text: "Export playlists", link: "/user-guide/export-playlists.html" }, { text: "Tags and audio writes", link: "/user-guide/tags-and-audio-writes.html" }] },
