...
`track_classifier_scores.score`. Бейдж `CLASS` в верхней панели считает треки,
у которых есть сохранённые оценки для всех продвинутых классификаторов: если
продвинутых классификаторов два, то две сохранённые оценки на одном треке
добавляют к бейджу единицу.
